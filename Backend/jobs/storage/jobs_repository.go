...
func (PostgresStorage) CreateJob(title, company string, skills []string, salary int, description, currency string) error {
...
func (PostgresStorage) UpdateJob(ID int, title, company string, skills []string, salary int, description, currency string) error {
	var count int
